...
header of python-developer-agent/skill.md.) If you cannot find or read any file, say so
explicitly instead of proceeding silently.

## Quick Reference

- Run tests: see python-developer-agent/config.md Development Commands table
- Run locally: see python-developer-agent/config.md Development Commands table
- Service bootstrap checklist: python-developer-agent/skill.md → Service Bootstrap section
- Observability contract: python-developer-agent/skill.md → Observability section
- CI/CD pipeline: python-developer-agent/skill.md → CI/CD section + config.md CI/CD section
- Quality gates: python-qa-agent/skill.md → Quality Gates section
