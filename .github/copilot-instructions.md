...
#
# This file ensures the developer and QA agent prompts are read before any
# coding work begins. VS Code with GitHub Copilot reads
...
stating: **"Loaded [project-name] developer and QA standards from skill.md
and config.md."** If you cannot find or read any file, say so
